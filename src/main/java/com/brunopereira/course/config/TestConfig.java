package com.brunopereira.course.config;
...
import com.brunopereira.course.entities.Payment;
import com.brunopereira.course.entities.Product;
import com.brunopereira.course.entities.User;
import com.brunopereira.course.entities.enums.OrderStatus;
import com.brunopereira.course.repositories.CategoryRepository;
import com.brunopereira.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
  ...
  public void run(String... args) throws Exception {
    ...
    Order o2 = new Order(
      null, Instant.parse("2019-07-21T03:42:10Z"), u2, OrderStatus.WAITING_PAYMENT
    );
    Order o3 = new Order(
      null, Instant.parse("2019-07-22T15:21:22Z"), u1, OrderStatus.WAITING_PAYMENT
    );
